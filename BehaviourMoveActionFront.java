...
public class BehaviourMoveActionFront implements Behavior {

	private FriendMove friendMove;
	private MotorRotate motorRotate;
	private MotorFlip motorFlip;
	
	public BehaviourMoveActionFront(FriendMove friendMove, MotorRotate motorRotate, MotorFlip motorFlip) {
	...
	public boolean takeControl() {
		return friendMove.getStateMoveAction() == StateMoveAction.FRONT;
	}
