...
//Options for research purpose.
	 ...
	 *                 to convert the scramble string to the cube definition string.
	 *
	 * @param maxDepth defines the maximal allowed maneuver length. For random
	 *                 cubes, a maxDepth of 21 usually will return a solution in
	 *                 less than 0.02 seconds on average. With a maxDepth of 20 it
	 *                 takes about 0.1 seconds on average to find a solution, but it
	 *                 may take much longer for specific cubes.
	 *
	 * @param probeMax defines the maximum number of the probes of phase 2. If it
	 *                 does not return with a solution, it returns with an error
	 *                 code.
	 *
	 * @param probeMin defines the minimum number of the probes of phase 2. So, if a
	 *                 solution is found within given probes, the computing will
	 *                 continue to find shorter solution(s). Btw, if probeMin >
	 *                 probeMax, probeMin will be set to probeMax.
	 *
	 * @param verbose  determins the format of the solution(s). see USE_SEPARATOR,
	...
	/**
	 * @return 0: Found or Probe limit exceeded 1: at least 1 + maxDep2 moves away,
	 *         Try next power 2: at least 2 + maxDep2 moves away, Try next axis
	 */
