...
public class BehaviourMoveActionRight implements Behavior {

	private FriendMove friendMove;
	private MotorRotate motorRotate;
	private MotorFlip motorFlip;
	
	public BehaviourMoveActionRight(FriendMove friendMove, MotorRotate motorRotate, MotorFlip motorFlip) {
	...
	public boolean takeControl() {
		return friendMove.getStateMoveAction() == StateMoveAction.RIGHT;
	}
