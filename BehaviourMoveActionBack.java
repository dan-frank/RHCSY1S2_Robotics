...
public class BehaviourMoveActionBack implements Behavior {

	private FriendMove friendMove;
	private MotorRotate motorRotate;
	private MotorFlip motorFlip;
	
	public BehaviourMoveActionBack(FriendMove friendMove, MotorRotate motorRotate, MotorFlip motorFlip) {
	...
	public boolean takeControl() {
		return friendMove.getStateMoveAction() == StateMoveAction.BACK;
	}
